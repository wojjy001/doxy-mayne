...
This application has been designed to allow user to assess the influence of covariates on doxycyline concentations. This includes formulation, food and sex effects. The final model is described in equations in the "Model" tab (written as mrgsolve code).
